...
public class VisitorMap<K, L>
{
	...
	/**
	 * Returns whether the given Link has been visited from the given Key, if this VisitorMap does
	...
	/**
	 * Returns whether all Links have been visited from the given Key, returning false
